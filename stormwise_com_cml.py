...
provide command line input and output for StormWISE_Com
the Community of Arts and Humanities StormWISE model
"""
import yaml
import os
from copy import deepcopy
from StormWISE_Com_Engine.stormwise_com import stormwise
from StormWISE_Com_Engine.stormwise_com import evaluate_solution
from StormWISE_Com_Engine.stormwise_com_benefits_and_bounds import benefit_slopes
from StormWISE_Com_Engine.stormwise_com_benefits_and_bounds import upper_bounds
from StormWISE_Com_Engine.stormwise_com_benefits_and_bounds import convert_benefit_units
from StormWISE_Com_Engine.stormwise_com_benefits_and_bounds import format_and_convert_benefit_dict
from Arts_Python_Tools.tools import multiply_dict_by_constant
from Arts_Python_Tools.tools import format_dict_as_strings

amplPath = "/Applications/amplide.macosx64/ampl"  # note: you must also set the solver path in stormwise_com.run
...
def main():
    print "\n\nStormWISE_Com COMMAND LINE VERSION\n"
    print "Instructions:"
